...
const StickerInputNode = ({ id, data, selected }) => {
        ...
        <div>
            <div className='flex gap-[2px]'>
                ...
                >
                    ...
                    {data?.imageData?.src ? <div className='my-1 w-[300px]'>
...
export default StickerInputNode