...
const ListMenu = () => {
    ...
    const handleSettingNewItems = (e, inputTitle) => {
        ...
        let getId = listSectionItems.map(item => item.id).slice(-1)
                                    ...
                                    <div className='flex flex-col gap-4 my-10'>
                                        ...
                                        <div>
                                            ...
                                            <div>
                                                ...
                                                <Input onChange={(e) => [handleEditingItem(e, "section-item-desc-edit"), setSectionItemDescInputVal(e.target.value)]} value={sectionItemDescInputVal} placeholder='Enter item description' />
                                            </div>
                                        </div>
                                ...
                                <div>
                                    <div className='flex flex-col gap-4 my-10'>
                                        ...
                                        <div>
                                            ...
                                            <div>
                                                <Input onChange={(e) => handleSettingNewItems(e, "section-item-desc-new")} value={newItemsObj.desc} placeholder='Enter item description' />
                                            </div>
                                        </div>
